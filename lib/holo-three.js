import * as Three__namespace from 'three'
const exports = {};
    ...
    export class HoloVideoObjectThreeJS {
        onEndOfStream;
        hvo;
        renderer;
        state;
...
// export const HoloVideoObject = HoloVideoObject;
// export const HoloVideoObjectThreeJS = HoloVideoObjectThreeJS;
